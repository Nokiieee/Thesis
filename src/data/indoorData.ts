...
export const indoorData: Record<string, IndoorItem> = {
  hydroponics: {
    ...
    steps: {
      ...
      tl: [
        "Ang hydroponics ay isang paraan ng pagtatanim ng letsugas na hindi gumagamit ng lupa, kundi gumagamit ng tubig na may halong sustansya.",
        ...
        "Maglagay ng net cups upang suportahan ang mga punla ng letsugas.",
        ...
        "Anihin ang letsugas pagkatapos ng 30–45 araw kapag ganap nang lumaki ang mga dahon.",
      ],
    },
  },
  ...
  aquaponics: {
    ...
    steps: {
      ...
      tl: [
        "Ang aquaponics ay isang sistema na pinagsasama ang pag-aalaga ng isda (tilapia) at pagtatanim ng letsugas sa iisang sistema.",
        ...
        "Itanim ang mga punla ng letsugas sa grow bed.",
        ...
        "Anihin ang letsugas sa loob ng 30–45 araw at ang tilapia sa loob ng 4–6 na buwan.",
      ],
    },
  },
  ...
  aeroponics: {
    ...
    steps: {
      ...
      tl: [
        "Ang aeroponics ay isang paraan ng pagtatanim ng letsugas kung saan ang mga ugat ay nakabitin sa hangin at binubugahan ng ambon na may nutrients.",
        ...
        "Ilagay ang mga punla ng letsugas na nakalantad ang mga ugat.",
        ...
        "Anihin ang letsugas sa loob ng 30–45 araw.",
      ],
    },
  },
};
